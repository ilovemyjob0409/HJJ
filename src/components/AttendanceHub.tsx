...
import { CLASS_HIDDEN_STATUSES, MINIMAL_HIDDEN_STATUSES } from '@/components/attendanceStatusOptions';
      ...
      >
        ...
        {rosterRows && (
          <AttendanceRosterEditor
            ...
            hiddenStatuses={opening?.type === 'CLASS' ? CLASS_HIDDEN_STATUSES : MINIMAL_HIDDEN_STATUSES}
          />
        )}
      </Modal>
      {ConfirmDialog}
