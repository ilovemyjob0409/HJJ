...
// 個別輔導收費標準及規範（2026-08-20 與負責人定稿 v6：週 2 堂制＋缺課補課制，
// 取代原月 8 堂遞延制）。缺席處理：學生在行事曆取消已預約的日期，另約其他
// 可預約時段補課；該期結束仍未預約之堂數不另外退費。未取消、逕自未到課者
// 不提供補課。
...
const RULES: { title: string; body: string }[] = [
  ...
  {
    title: '缺席與補課',
    body: '如遇已預約之日期需缺席，可至行事曆取消該筆預約，並另約其他可預約時段補課；未經取消、逕自未到課者不提供補課。該期結束仍未預約之堂數，不另外退費。',
  },
  {
    title: '未預約到場',
